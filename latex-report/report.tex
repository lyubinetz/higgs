...
\begin{table}[h]
	\begin{tabular}{ |M{1.5cm}|M{1.5cm}|M{1.5cm}|M{1.8cm}|  }
		...
		\hline
	\end{tabular}
	\caption{Results obtained on a 3-fold cross-validation evaluation for the specified models using different approaches for feature augmentation}
...
\bibitem{docs} 
Claire Adam-Bourdarios et al.
\href{https://higgsml.lal.in2p3.fr/files/2014/04/documentation_v1.8.pdf}{Learning to discover: the Higgs
boson machine learning challenge}, 2014.
 
\bibitem{variance} 
CS 231n.
\href{http://cs231n.github.io/neural-networks-2/#init}{Calibrating the variances with 1/sqrt(n)}

\bibitem{relu} 
Rectified linear unit.
\href{https://en.wikipedia.org/wiki/Rectifier_(neural_networks)}{ReLU on wiki}

\bibitem{softmax} 
Softmax loss function.
\href{http://cs231n.github.io/linear-classify/#softmax}{CS231n softmax}

\bibitem{rmsprop} 
G. Hinton et al. Lecture 6 - RMSProp, COURSERA: Neural Networks for Machine Learning, slide 29
\href{http://www.cs.toronto.edu/~tijmen/csc321/slides/lecture_slides_lec6.pdf}{link}

\bibitem{rbf} 
Rbf on wiki
\href{https://en.wikipedia.org/wiki/Radial_basis_function_kernel}{link}
